...
function CheckTree(myName){
	...
	CheckTree.prototype.init=function(){
		with(this){if(!document.getElementById)return;
		...
		if(root){
			...
			for(var ul=0;ul<lists.length;ul++){
				...
				}else lists[ul].onclick=fn}root.treeObj=this;
