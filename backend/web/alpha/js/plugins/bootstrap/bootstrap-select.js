(function ($) {
  ...
  Selectpicker.prototype = {
    ...
    render: function (updateLi) {
      ...
      //Fixes issue in IE10 occurring when no default option is selected and at least core option is disabled
    ...
    clickListener: function () {
      ...
      this.$menu.on('click', 'li a', function (e) {
        ...
        if (!that.isDisabled() && !$(this).parent().hasClass('disabled')) {
          ...
          //Else toggle the core we have chosen if we are multi select.
          else {
